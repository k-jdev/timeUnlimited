...
function Checkbox({
  ...
  return (
    <CheckboxPrimitive.Root
      data-slot="checkbox"
      className={cn(
        "peer relative flex size-4 shrink-0 items-center justify-center border border-[rgba(255,255,255,0.2)] transition-shadow outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:border-[#0090ff] data-[state=checked]:bg-[#0090ff] data-[state=checked]:text-white data-[state=checked]:shadow-[inset_0px_1.5px_2px_0px_rgba(0,0,0,0.1)]",
        className
      )}
      {...props}
    >
